...
export const GradientCard = ({text, para}) => {
  ...
  return (
    <div className="md:w-full w-[270px] h-screen flex items-center justify-center">
      ...
      <motion.div
        ...
        <motion.div
          className="absolute bottom-0 left-0 h-1/4 w-[1px] z-25 rounded-xl"
          style={{
        ...
        <motion.div
          className="absolute bottom-0 right-0 h-1/4 w-[1px] z-25 rounded-xl"
          style={{
            background: "linear-gradient(to top, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.5) 20%, rgba(255, 255, 255, 0.3) 40%, rgba(255, 255, 255, 0.1) 60%, rgba(255, 255, 255, 0) 80%)",
          }}
          animate={{
        ...
        <motion.div
          ...
          <motion.div
            className="w-full h-[300px] rounded-xl flex items-center justify-center mb-6"
            style={{
          ...
          <div className="flex items-center justify-center w-full h-full relative z-10">
              <img src="/img/assets/img_howwemade.png"/>
            </div>
